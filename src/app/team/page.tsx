    ...
    people: [
      {
        ...
        image: "/professional_photos/vinu.jpeg",
      },
      {
        name: "Julia Nguyen",
        role: "VP External",
      ...
      },
      {
        ...
        role: "VP Operations",
        major: "Math · CS",
        image: "/professional_photos/prachi.jpg",
      },
      {
        name: "Parvathy Jayaram",
        role: "Director of Marketing",
        major: "Human Bio",
        image: "/professional_photos/parvathy.png",
      },
    ],
  },
  {
    title: "Operations & External Relations",
    people: [
      {
        name: "Ritu Doshi",
        role: "Event Logistics",
        major: "CS · Bioinformatics",
        image: "/professional_photos/ritu.jpeg",
      },
      {
        name: "Krushy Acharya",
      ...
      },
      {
        ...
        major: "Economics",
        image: "/professional_photos/shiv.png",
      },
      {
        name: "Jasmin Rosato",
        role: "External Relations",
        major: "Cognitive & Behavioral Neuroscience",
        image: "/professional_photos/jasmin.png",
      },
      {
        name: "Mariya Alsaiari",
        role: "Operations Coordinator",
        major: "Bio · Bioinformatics",
        image: "/professional_photos/mariya.jpg",
      },
    ],
  },
  {
    ...
    people: [
      {
        ...
        image: "/professional_photos/kaitlyn.jpg",
      },
      {
        name: "Nicole Chen",
        role: "Design Coordinator",
        major: "Cognitive Science · ML",
        image: "/professional_photos/nicole.jpeg",
      },
      {
        name: "Tanishq Singh Rathore",
        role: "Social Media Manager",
        major: "Cognitive Science · M",
        image: "",
      },
    ],
  },
    ...
    people: [
      {
        ...
        major: "Data Science",
        image: "/professional_photos/siya.jpeg",
      },
      {
        name: "Laksh Goyal",
        role: "Software Developer",
      ...
      },
      {
        ...
        major: "Bio · Bioinformatics",
        image: "/professional_photos/pratyush.png",
      },
            ...
            <div
              className={`grid ${
                section.people.length === 3
                  ? "grid-cols-3 justify-items-center gap-1"
                  : section.title === "Operations & External Relations"
                    ? "grid-cols-2 md:grid-cols-5 gap-8"
